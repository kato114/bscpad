              ...
              <div className="table-responsive">
                <table className="table mb-0 pp-table-info">
                  <tbody>
                    ...
                    {Boolean(schedules) &&
                      Object.values(schedules).map((schedule, ind) => {
                        return (
                          <tr>
                            <td>
                              {schedule.round}
                            ...
                            <td>
                              <button
                                onClick={() =>
                                  handleDeleteRow(Object.keys(schedules)[ind])
                                }
                              >
                                Delete
                              </button>
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="">
              ...
              <Form.Control
                type="text"
                onChange={(e) => handleOnChnage(e, "round")}
            ...
            <Form.Group className="mb-3" controlId="">
              ...
              <Form.Control
                type="text"
                onChange={(e) => handleOnChnage(e, "open")}
                placeholder="2021-12-10 09:00:00 UTC"
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="">
              ...
              <Form.Control
                type="text"
                onChange={(e) => handleOnChnage(e, "close")}
